                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6 col-md-4">
                                        <a href="customAddressLabels.html" class="prod-item">
                                            ...
                                            <h4>
                                                custom business label printing
                                            </h4>
                                        </a>
                                    </div>
                                    <!-- Single Product Item -->
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-12">
                            <div class="detail-area" data-simplebar data-simplebar-auto-hide="true"
                                ...
                                <article>
                                    <h3 class="text-center text-uppercase" style="font-size: 28px;">
